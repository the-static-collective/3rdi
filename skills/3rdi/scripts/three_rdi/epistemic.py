"""Observer-local epistemic trace compilation layered over the base cut compiler."""
...
from .model import FieldError, canonical_digest, parse_instant
...
def _withheld(kind: str, reason: str) -> dict[str, str]:
    """Return an observer-safe diagnostic category without hidden event identity."""
